...
def main():
    ...
    parser.add_argument(
        '--obj_path',
        type=str,
        default='./experiment/data/val.obj',
        help='the obj file you infer')
    ...
    parser.add_argument(
        '--src_font',
        type=str,
        default='charset/gbk/方正新楷体_GBK(完整).TTF')
    ...
    print(
        'cold start time: %.2f, hot start time %.2f' %
        (t_finish - t0, t_finish - t1))
