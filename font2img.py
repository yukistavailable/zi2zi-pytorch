...
def draw_font2imgs_example(
        ...
        y_offset):
    src_img = draw_single_char(ch, src_font, canvas_size, x_offset, y_offset)
    dst_img = dst_img.resize((canvas_size, canvas_size),
...
def draw_imgs2imgs_example(src_img, dst_img, canvas_size):
    src_img = src_img.resize((canvas_size, canvas_size),
                             Image.ANTIALIAS).convert('RGB')
    dst_img = dst_img.resize((canvas_size, canvas_size),
                             Image.ANTIALIAS).convert('RGB')
    example_img = Image.new(
...
def fonts2imgs(src_fonts_dir, dst, char_size, canvas_size,
    ...
    fontPlane00 = TTFont(
        os.path.join(
            src_fonts_dir,
            'FZSONG_ZhongHuaSongPlane00_2020051520200519101119.TTF'))
    fontPlane02 = TTFont(
        os.path.join(
            src_fonts_dir,
            'FZSONG_ZhongHuaSongPlane02_2020051520200519101142.TTF'))
    ...
    for c in tqdm(os.listdir(dst)):
        ...
        if ch in charSetPlane00:
            e = draw_font2imgs_example(
                ch, fontPlane00, dst_img, canvas_size, x_offset, y_offset)
        elif ch in charSetPlane02:
            e = draw_font2imgs_example(
                ch, fontPlane02, dst_img, canvas_size, x_offset, y_offset)
        else:
            e = None
        if e:
            e.save(os.path.join(sample_dir, "%d_%04d.jpg" % (label, count)))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='path of the source font')
    parser.add_argument(
        '--src_fonts_dir',
        type=str,
        default=None,
        help='path of the source fonts')
    parser.add_argument(
        '--src_imgs',
        type=str,
        default=None,
        help='path of the source imgs')
    parser.add_argument(
        '--dst_font',
        type=str,
        default=None,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='path of the target imgs')

    parser.add_argument(
        '--filter',
        default=False,
        action='store_true',
        help='filter recurring characters')
    parser.add_argument(
        '--charset',
        type=str,
        default='CN',
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help='shuffle a charset before processings')
    parser.add_argument(
        '--char_size',
        type=int,
        default=256,
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help='label as the prefix of examples')
